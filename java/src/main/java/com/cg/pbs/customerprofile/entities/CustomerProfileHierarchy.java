...
public class CustomerProfileHierarchy {
    ...
    public CustomerProfileHierarchy()
    {
        super();
    }

	public CustomerProfileHierarchy(int customerId, int countrycode, int businessArea, int profile, int subProfile, String value, String valueType)
    {
        super();
